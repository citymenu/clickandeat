    ...
    <div class="content-wrapper">
        <div class="content-left">
            <div id="contactdetails">
                <div class="checkoutheader"><message:message key="user.your-details"/></div>
                <div>
                    <div class="detailsitem">
                        <div class="detailslabel"><message:message key="user.first-name"/></div>
                        <div class="detailsfield"><input type="text" name="firstName" class="checkoutfield" value="${order.customer.firstName}"/></div>
                    </div>
                    <div class="detailsitem">
                        <div class="detailslabel"><message:message key="user.last-name"/></div>
                        <div class="detailsfield"><input type="text" name="lastName" class="checkoutfield" value="${order.customer.lastName}"/></div>
                    </div>
                    <div class="detailsitem">
                        <div class="detailslabel"><message:message key="user.contact-number"/></div>
                        <div class="detailsfield"><input type="text" name="telephone" class="checkoutfield" value="${order.customer.telephone}"/></div>
                    </div>
                    <div class="detailsitem">
                        <div class="detailslabel"><message:message key="user.email-address"/></div>
                        <div class="detailsfield"><input type="text" name="email" class="checkoutfield" value="${order.customer.email}"/></div>
                    </div>
                </div>

                <div class="checkoutheader"><message:message key="checkout.delivery-details"/></div>
                <div>
                    <div class="detailsitem">
                        <div class="detailslabel"><message:message key="user.address"/></div>
                ...
                <div id="additionalinstructions">
                    <div class="checkoutheader"><message:message key="order.additionalinstructions"/></div>
                    <div>
                        <div class="checkoutsummary"><message:message key="label.additional-instructions-text"/></div>
                ...
                <div><a href="javascript:proceed();" class="menuitem-button add-button unselectable"><message:message key="button.payment"/></a></div>
            </div>
        </div>
