            ...
            <div id="searchbar-wrapper">
                <div class="triangle-right left">
                    <div class="searchbar-content">
                        ...
                        <div class="location-direct unselectable">O entra directamente en: <a class="location" href="${ctx}/app/comida-a-domicilio-en-madrid/loc/Madrid"/>Madrid</a> / <a class="location" href="${ctx}/app/comida-a-domicilio-en-barcelona/loc/Barcelona"/>Barcelona</a>
