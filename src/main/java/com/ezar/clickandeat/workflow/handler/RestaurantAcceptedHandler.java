...
public class RestaurantAcceptedHandler implements IWorkflowHandler {
    ...
    public String getWorkflowAction() {
        return OrderWorkflowEngine.ACTION_RESTAURANT_ACCEPTED;
    }
    ...
    public Order handle(Order order, Map<String, Object> context) throws WorkflowException {
        ...
        try {
            ...
            LOGGER.error("Error sending confirmation of restaurant acceptance to customer");
            throw new WorkflowException(ex);
        }

        order.setOrderStatus(OrderWorkflowEngine.ORDER_STATUS_RESTAURANT_ACCEPTED);
        return order;
    }
